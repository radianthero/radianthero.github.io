---
title: Art tutorial 2
date: 2024-7-10 12:00:00 -500
catagories: [art]
tags: [art, tutorial]
---
...
<audio controls>
    <source src="/audio/Donpan Bushi.flac">
</audio>
...
![Starting hand](/assets/images/hand%20part%201.png)

From there, you want to start adding the cylinders, attempting to make it both flushed together. 

![Adding fingers to hand](/assets/images/hand%20part%202.png)
...
![Fixing up the hand](/assets/images/hand%20part%203.png)
...
<audio controls>
    <source src="/audio/April in Paris.flac">
</audio>

Following what we just learned, I create the hands desired for my pose. 

![Adding the hands to our picture](/assets/images/rought%20body%202.png) 
...
![Dividing into three parts](/assets/images/head%20part%203.png)
...
We'll be adding eyes above area 4, in area 2, and area 4, make sure to put it in between, like shown. 

![Adding eyes](/assets/images/head%20part%204.png)

Now for the lips, they're gonna be in the middle of the eye, above line 6.

![Adding Lips](/assets/images/face%20part%205.png)

The ears will be added in the middle of the eye to about the nose bottom.

![Adding ears to the head](/assets/images/face%20part%206.png)
...
<https://web.archive.org/web/20030423135426/http://www1.dnet.gr.jp/~takayuki/syonen/art/frame.html>

I recommend reading through the beginner section. 

Now we'll add this to our body!

![Adding facial features to body](/assets/images/rough%20body%203.png)

## Now we'll finish with feet. 

<audio controls>
    <source src="/audio/One Last Time.flac">
</audio>
...
![Feet](/assets/images/rough%20feet%201.png)
