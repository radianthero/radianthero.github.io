...
<audio controls>
    <source src="/audio/The Militia.flac">
</audio>
...
Here's a baseline. You want to ensure you're drawing OVER the skin, not on the skin. 

![Example of a shirt](/assets/images/shirt.png)
...
Next, we'll add some pants. This one tends to be easier to draw for most people.  

![Example of pants](/assets/images/pants.png)

This looks rather simple, but it's just a sketch! Now, we'll add some more detail. 

First, we'll delete the inside of the shirts/pants to clean up the image.

<audio controls>
    <source src="/audio/Guitars, Whiskey, Guns And Knives.mp3">
</audio>

![Cleaned up shirt and pants](/assets/images/shirt%20and%20pants.png)
...
![New shirts and pants](/assets/images/shirt%20pants%20redone.png)

Went from a fairly flat image to now something better.


That's all the work done today! I'm pretty happy with it! The next lesson will be cleaning up the reast of the art, and adding a few more details. 