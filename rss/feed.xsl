  ...
  <xsl:template match="/">
    <html xmlns="http://www.w3.org/1999/xhtml">
      <head>
        ...
        <style type="text/css">
          body { max-width: 768px; margin: 0 auto; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol"; font-size: 16px; line-height: 1.5em; }
          section { margin: 30px 15px; }
          h1 { font-size: 2em; margin: .67em 0; line-height: 1.125em; }
      ...
      <body>
        <section>
          <div class="alert">
            <p><strong>This is a web feed</strong>, also known as an RSS feed. <strong>Subscribe</strong> by copying the URL from the address bar into an RSS reader. Recommended readers: Feeder, Raven Reader, or NetNewsWire.</p>
          </div>
        </section>
        <section>
